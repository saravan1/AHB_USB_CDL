...
COMPONENT_FILES	:= decoder.sv EOP_detector.sv edge_detector.sv sync_high.sv sync_low.sv timer.sv pid_rx.sv control_rx.sv flex_stp_sr.sv shift_register.sv
