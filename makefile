...
COMPONENT_FILES	:= ahb_lite_slave.sv control.sv control_rx.sv databuffer.sv decoder.sv edge_detector.sv encoder.sv EOP_detector.sv tx_flex_counter.sv flex_pts_sr.sv flex_stp_sr.sv shift_register.sv sr_8bit.sv sync_high.sv sync_low.sv timer.sv timer_rx.sv usb_rx.sv usb_tx.sv
#decoder.sv EOP_detector.sv edge_detector.sv sync_high.sv sync_low.sv timer_rx.sv control_rx.sv flex_stp_sr.sv shift_register.sv tx_flex_counter.sv
#ahb_lite_slave.sv control.sv databuffer.sv decode.sv edge_detect.sv encoder.sv eop_detect.sv flex_counter.sv flex_pts_sr.sv PID_detect.sv rcu.sv sr_8bit.sv sync_high.sv sync_low.sv timer.sv usb_rx.sv usb_tx.sv flex_stp_sr.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= ahb_lite_usb.sv
#ahb_lite_usb.sv
